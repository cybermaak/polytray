...
- Watch the sandbox run actively for up to 10 minutes.
- If the run is still in progress after 10 minutes, stop watching and wait for the user to check and report the final result before resuming work.
